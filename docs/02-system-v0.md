...
6. **The vertical axis is finite, the horizontal one is not.** A story is five paragraphs; a moment holds as many versions as people care to write. What ends is the story, not the reading. Five dots in the apparatus say which of the five paragraphs you are standing on.
