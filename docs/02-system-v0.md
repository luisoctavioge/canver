...
|---|---|---|
| Turns per period | 1 a day (stated, never counted) | Enough to have judgement, too few to make noise. *(Was 3 a week until 05-sep-2026.)* They are not handed out by a nightly job: each person collects what they are owed the next time they show up, so there is no scheduler to maintain. The bottom bar says the cadence — «1 turno por día» — and not how many you have left: counting turns is still counting. It only changes its mind when you have none, because the invitation to write disappears with them and silence there reads as a fault. *(06-sep-2026.)* |
