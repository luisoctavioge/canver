...
- Reading the previous last line and then reading different paragraphs was good.
- Some versions were likeable and the impulse was **to support them** — that is where the like comes from, not from theory.
- Empty ones produced the impulse **to contribute**.

That order matters: the like and the sideways contribution were not designed, they were felt while reading. Worth keeping that as the reason.
